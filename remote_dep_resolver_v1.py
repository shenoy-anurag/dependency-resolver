...
def main():
    ...
    print(json.dumps({args.package: tree}, indent=2))
    with open("dependency_tree_{}.json".format(args.package + str(args.version)), 'w') as f:
        content = json.dumps({args.package: tree}, indent=2)
        f.write(content)
